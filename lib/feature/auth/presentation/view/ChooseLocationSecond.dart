...
class ChooseLocationSecond extends StatelessWidget {
  const ChooseLocationSecond({super.key});
              ...
              Row(
                ...
                children: [
                  OptionCard(
                    ...
                    label: 'سائق',
                    onTap: () {
                      GoRouter.of(context).push(AppRouter.KSignUpPageDriver);
                    },
                  ),
                  OptionCard(
                    ...
                    label: 'راكب',
                    onTap: () {
                      GoRouter.of(context).push(AppRouter.KSignUpPageRider);
                    },
                  ),
                ],
              ),
