...
class CheckboxWidgetDriver extends StatefulWidget {
  final Function(bool, bool) onChanged; // استقبال التغييرات

  const CheckboxWidgetDriver({super.key, required this.onChanged});

  @override
  _CheckboxWidgetDriverState createState() => _CheckboxWidgetDriverState();
}

class _CheckboxWidgetDriverState extends State<CheckboxWidgetDriver> {
